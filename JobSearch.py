...
class PythonOrgSearch(unittest.TestCase):
    ...
    def test_TC_JO_012(self):
        ...
        self.driver.find_element(By.XPATH, '//*[@id="__next"]/div[7]/div[2]/div[2]/div/div/div[1]/div[1]/span/div[2]/div[1]/div/div[2]/div[1]').click()
        self.driver.find_element(By.XPATH, '//*[@id="__next"]/div[7]/div[2]/div[2]/div/div/div[1]/div[1]/span/div[1]').click()
        self.driver.find_element(By.XPATH, '//*[@id="__next"]/div[7]/div[2]/div[2]/div/div/div[1]/div[1]/span/div[2]/div[2]/div[2]/div[1]').click()
        self.driver.find_element(By.XPATH, '//*[@id="__next"]/div[7]/div[2]/div[2]/div/div/div[1]/div[1]/span/div[2]/div[2]/div[2]/div[5]').click()
        search.send_keys('Computer Science Engineer',Keys.ENTER)
        self.driver.implicitly_wait(5)
        expect_text = 'We have not found jobs for this search at the moment'
        actual_text = self.driver.find_element_by_xpath('//*[@id="__next"]/div[7]/div[2]/main/div/div/div[1]/div[1]/div[1]/div/h1').text
        result = True if expect_text in actual_text else False
        self.assertTrue(TestUtil.checkTestcase(result, True, "TC-JO-0012"))
        


    def test_TC_JO_013(self):
        search = self.driver.find_element(By.ID,"main-search-bar")
        self.driver.implicitly_wait(1)
        ...
        self.assertTrue(TestUtil.checkTestcase(result, False, "TC-JO-0013"))
